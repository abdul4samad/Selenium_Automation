...
public class Reports {
	 ...
	 * 
	 * @param testName
	 *            This param will the test case name for particular test case.
	 * @param desc
	 *            This param is the description of the test cases
	 */
	 ...
	 * 
	 * @param desc
	 *            This param is description of info log that will be flushed in
	 *            reports
	 */
	 ...
	 * 
	 * @param desc
	 *            This param is description of Pass log that will be flushed in
	 ...
	 * 
	 * @param desc
	 *            This param is description of Failure log that will be flushed
	 ...
	 * 
	 * @param details
	 *            This param is the details of the log
	 * @param imagePath
	 *            this param will pass the path of the screenshot.
	 */
