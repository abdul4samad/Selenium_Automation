...
public class ReUpdateAssessment {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            for (HashMap<String, String> map : data) {
                ...
                if (!Files.exists(Paths.get(filePath)) && !enrolmentNumbers.contains(enrolmentNumber)) {
                    continue;
                }
                try {
                    try {
                        ...
                        Thread.sleep(5000);
                        /*Select select = new Select(Utility.getLocator("disability_type_id", "id"));
                        select.selectByVisibleText(disabilityType);*/
